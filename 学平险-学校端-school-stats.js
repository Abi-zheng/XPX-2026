...
(function (global) {
  ...
  var RECENT_RISK_EVENTS = [
    { lv: 'high', label: '较严重', time: '2026-05-19 14:22:00', title: '高三(1)班 · 体育课摔伤', meta: '李明远 · 右脚踝软组织扭伤，已就医并报案' },
    { lv: 'warn', label: '一般', time: '2026-05-18 10:08:00', title: '高二(1)班 · 课间碰撞', meta: '陈雨桐 · 额头轻微擦伤，校医室处理' },
    { lv: 'warn', label: '一般', time: '2026-05-15 12:30:00', title: '初三(3)班 · 食堂烫伤', meta: '郑子涵 · 左手背一级烫伤，跟踪中' },
    { lv: 'light', label: '轻微', time: '2026-05-08 11:18:00', title: '高一(3)班 · 课间打闹擦伤', meta: '刘子轩 · 校医处理，已通知家长' }
  ];
